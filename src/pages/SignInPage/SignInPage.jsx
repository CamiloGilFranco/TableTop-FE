        ...
        <form action="" className="sign-in-page-form" onSubmit={handleSubmit}>
          ...
          <div className="sign-in-page-form-input-container sign-in-page-form-input-container">
            ...
            <div className="sign-in-page-form-input-subcontainer">
              <select
                ...
                value={formContent.documentType}
                onChange={(event) =>
                  setFormContent({
                    ...formContent,
          ...
          <div className="sign-in-page-form-checkbox-container">
            <input
              ...
              checked={formContent.termsAndConditions}
              onChange={() =>
                setFormContent({
                  ...formContent,
                  termsAndConditions: !formContent.terminosYCondiciones,
                })
              }
            />
            <label
          ...
          <div className="sign-in-page-form-checkbox-container">
            <input
              ...
              className="sign-in-page-form-checkbox"
              checked={formContent.dataProcessing}
              onChange={() =>
                setFormContent({
                  ...formContent,
                  dataProcessing: !formContent.dataProcessing,
                })
              }
            />
            <label
          ...
          <div className="sign-in-page-form-checkbox-container">
            <input
              ...
              className="sign-in-page-form-checkbox"
              checked={formContent.emailInformation}
              onChange={() =>
                setFormContent({
                  ...formContent,
                  emailInformation: !formContent.emailInformation,
                })
              }
            />
            <label
          ...
          <div className="sign-in-page-form-checkbox-container">
            <input
              ...
              className="sign-in-page-form-checkbox"
              checked={formContent.smsInformation}
              onChange={() =>
                setFormContent({
                  ...formContent,
                  smsInformation: !formContent.smsInformation,
                })
              }
            />
            <label
          ...
          <div className="sign-in-page-form-checkbox-container">
            <input
              ...
              className="sign-in-page-form-checkbox"
              checked={formContent.wppInformation}
              onChange={() =>
                setFormContent({
                  ...formContent,
                  wppInformation: !formContent.wppInformation,
                })
              }
            />
            <label
