const languageSelector = (lang, str) => {
  const en = {
    ...
    deactivateUserWarning: 'Are you sure you want to deactivate this user? This action cannot be undone.',
  ...
  const es = {
    ...
    deactivateUserWarning: '¿Seguro que quieres desactivar este restaurante? Esta acción no se puede revertir.',
