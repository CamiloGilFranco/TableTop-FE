const languageSelector = (lang, str) => {
  ...
  const en = {
    ...
    orderSuccessBody: 'Thank You For Your Payment. We Have Recieved Your Payment Succesfully. Your Transaction ID Is',
   ...
   const es = {
    ...
    orderSuccessBody: 'Gracias por tu pago. Hemos recibido tu pago con éxito. Tu ID de transacción es',
    orderSuccessBodyTwo: '¡Pronto recibirás una factura por correo electrónico!',
