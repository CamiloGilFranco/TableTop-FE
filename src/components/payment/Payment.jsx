    ...
    <main className="payment-container">
      ...
      <section className="payment-content">
        ...
        <div className="payment-content__header">
          <div className="payment-content__header--icon">
            {<BsRecord2 color="red" size="30px" />}
          </div>
          <p className="payment-content__header--paragraph">
            <b>Debit Card</b>
          </p>
        </div>
        <form action="" className="payment-form">
          <label htmlFor="nombre" className="payment-form-name">
            ...
            <input
              type="text"
              id="nombre"
              className="payment-form__input-name"
            />
          </label>
          <label htmlFor="number">
            ...
            <div className="payment-card-info">
              <input
                type="number"
                id="number"
                className="payment-card-info__number"
              />
              <img
                src={typesCards}
                alt=""
                className="payment-card-info__images"
              />
            </div>
          </label>
        </form>
      ...
      <form className="payment-form-way-pay">
        <div className="type__payment">
          ...
          <label htmlFor="card" className="type-payment-text">
            <b>Credit Card</b>
          </label>
          <br />
        </div>
        <div className="type__payment">
          ...
          <label htmlFor="net" className="type-payment-text">
            <b>Net Banking</b>
          </label>
          <br />
        </div>
        <div className="type__payment">
          ...
          />
          <label htmlFor="wallet" className="type-payment-text">
            <b>My Wallet</b>
          </label>
        </div>
      </form>
